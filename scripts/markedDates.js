const markedDates = function() {
    ...
    const getDateList = function(start, end, frequency, exceptions) {
    ...
    const classNames = crcResponderDates.map(() => 'crcResponder')
                        .concat(gisVolunteerDates.map(() => 'gis'))
                        .concat(junoJSCourseDates.map(() => 'junoJSCourse'))
                        .concat(junoBootcampDates.map(() => 'junoBootcamp'))
                        .concat(courseraAlgoIDates.map(() => 'courseraAlgoI'))
                        .concat(courseraAlgoIIDates.map(() => 'courseraAlgoII'));
